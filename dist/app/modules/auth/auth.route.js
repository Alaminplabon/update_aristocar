...
router.post('/admin/login', (0, validateRequest_1.default)(auth_validation_1.authValidation.loginZodValidationSchema), auth_controller_1.authControllers.adminLogin);
...
router.patch('/change-password', (0, auth_1.default)(user_constants_1.USER_ROLE.dealer, user_constants_1.USER_ROLE.admin, user_constants_1.USER_ROLE.user), auth_controller_1.authControllers.changePassword);
