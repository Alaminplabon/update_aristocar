...
const createContents = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contents_service_1.contentsService.createContents(req.body, req.files);
...
const updateContents = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contents_service_1.contentsService.updateContents(req.body, req.files);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const deleteBanner = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contents_service_1.contentsService.deleteBanner(req.params.key);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
